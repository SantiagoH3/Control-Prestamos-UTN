...
public class ingresoPres_Equipos extends javax.swing.JFrame {
    ...
    public ingresoPres_Equipos() {
         initComponents();
        setTitle("Prestamos de equipos y/o material");//esto
    ...
    void mostrardatos(String valor) {
        String autorizado = "";
        String[] titulos = {"Id", "Fecha", "Autorizado", "Persona", "Equipo"};
        String[] registros = new String[5];
        String sql = "SELECT peq.id_preseq\n"
                + "          ,peq.fecha\n"
                + "	   ,peq.autorizado	   \n"
                + "	   ,CONCAT(p.nombre,' ',p.apellido) AS persona	   \n"
                + "	   , eq.nombre AS equipo\n"
                + "FROM pres_equipos peq\n"
                + "INNER JOIN personas p ON p.id_persona=peq.id_persona\n"
                + "INNER JOIN equipos eq ON eq.id_equipo=peq.id_equipo\n"
                + "WHERE CONCAT(peq.id_preseq,' ',peq.fecha,' ',peq.autorizado,' ',p.nombre,' ',p.apellido,' ',eq.nombre)"
                + " LIKE '%" + valor + "%'"
                + "ORDER BY id_preseq ASC";
        ...
        try {
            ...
            while (rs.next()) {
                if ("1".equals(rs.getString("peq.autorizado"))) {
                    autorizado = "True";
                }
                if ("0".equals(rs.getString("peq.autorizado"))) {
                    autorizado = "False";
                }
                registros[0] = rs.getString("peq.id_preseq");
                registros[1] = rs.getString("peq.fecha");
                registros[2] = autorizado;
                registros[3] = rs.getString("persona");
                registros[4] = rs.getString("equipo");
    ...
    void loadcomboEquipo() {
        String sql = "SELECT nombre FROM equipos ORDER BY nombre ASC";
        try {
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(sql);

            while (rs.next()) {
                cbEq.addItem(rs.getString(1));
            }
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, ex);
        }
    ...
    void confirmar_eliminar(){
        ...
        int eleccion = JOptionPane.showOptionDialog(this, "¿Desea eliminar el prestamo de "+equipo+"?", "Confirmar eliminar",
    ...
    void desbloquear() {       
        ...
        cbEq.setBorder(BorderFactory.createLineBorder(Color.GRAY, 0));
    ...
    void validating(){
       int cont = 0;
        ...
        Color gris = new Color(238,238,238);        
        if ("Seleccionar..".equals(cbEq.getSelectedItem())) {
            cbEq.requestFocus();
            cbEq.setToolTipText("Seleccione equipo");
            cbEq.setBorder(BorderFactory.createLineBorder(Color.RED, 1));
            cbEq.setBackground(rosita);
            cont = cont + 1;
        } else {
            cbEq.setToolTipText(null);
            cbEq.setBorder(BorderFactory.createLineBorder(Color.GRAY, 0));
            cbEq.setBackground(gris);
        }           
    ...
    void inserting() {
        ...
        try {
            String sql = "SELECT id_equipo FROM equipos WHERE nombre LIKE '" + cbEq.getSelectedItem().toString() + "'";
        ...
        try {
            PreparedStatement pst = cn.prepareStatement("INSERT INTO pres_equipos(fecha,autorizado, "
                    + "                                  id_persona, id_equipo) VALUES (?,?,?,?)");

            pst.setString(1, funciones.getFecha(dcCalendario));
            pst.setObject(2, autorizado);
            pst.setObject(3, per);
            pst.setObject(4, equipo);
    ...
    void updating() {
        ...
        try {
            PreparedStatement pst = cn.prepareStatement("UPDATE pres_equipos SET "
                    + "fecha='" + funciones.getFecha(dcCalendario) + "',"
                    + "autorizado='" + autorizado + "',"
                    + "id_persona='" + per + "',  "
                    + "id_equipo='" + equipo + "'  "
                    + "WHERE id_preseq='" + txtId.getText() + "'");
            pst.executeUpdate();
            mostrardatos("");
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, ex);
    ...
    void deleting() {
        ...
        try {
            PreparedStatement pst = cn.prepareStatement("DELETE FROM pres_equipos WHERE  id_preseq='" + id + "'");
            pst.executeUpdate();
            mostrardatos("");
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, ex);
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Prestamo de equipos"));
        ...
        cbEq.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccionar.." }));
        ...
        dcCalendario.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                dcCalendarioMouseClicked(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(cbAut, javax.swing.GroupLayout.Alignment.LEADING, 0, 147, Short.MAX_VALUE)
                            .addComponent(cbPer, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(cbEq, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtId)
...
private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
    ...
    if (fila >= 0) {
        ...
        cbEq.setSelectedItem(tEspacios.getValueAt(fila, 4).toString());
        txtId.enable(false);
    } else {
...
private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
    int fila = tEspacios.getSelectedRow();    
    equipo = tEspacios.getValueAt(fila, 4).toString();
    confirmar_eliminar();    
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
         ...
         String path = "C:\\Users\\Santiago\\Desktop\\Bases de datos pruebas\\BD prestamos ut\\control_prestamosV4\\src\\formularios\\Reportes\\report1.jasper";
...
//                + "\\src\\formularios\\Reportes\\report2.jasper";
    ...
    private void dcCalendarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dcCalendarioMouseClicked
        
    }//GEN-LAST:event_dcCalendarioMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ingresoPres_Equipos().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox cbEq;
